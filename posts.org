...
#+end_export
#+begin_aside
Diagram rendered by Mermaid.js which is a 1MB payload (ESM version), I'll investigate render at build. Edit: lots of issues with serving js, trying serving from static.
#+end_aside
