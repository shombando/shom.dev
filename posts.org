...
#+begin_export hugo
{{< fig src="./hummingbird-street.mp4" width= "400px" title="Hummingbird on the street" alt="Video of a sidestreet where a tiny green hummingbird is fluttering desperately but unable to fly or even make it onto the grass." align="center" >}}
#+end_export
