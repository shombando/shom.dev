...
#+begin_export hugo
{{< fig src="default_midnight_hunt.png" width= "800px" title="Midnight Hunt theme" alt="Screenshot of the theme, it has red edges fading to black in the middle  " align="center" >}}
#+end_export
