...
#+hugo: more
#+begin_export hugo
{{< fig src="logos.png" width= "600px" title="All the apps!" alt="Logos of Omnivore, Hoarder (now Kara Keep), Wallabag, and Readeck in increasing size from left to right against a blue to orange fill gradient." align="center" >}}
#+end_export
