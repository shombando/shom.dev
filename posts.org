...
* Content
** DRAFT Photos meta data: the disjointed state of EXIF, XMP, IPTC in tools :hugo:foss:exif:
:PROPERTIES:
...
[[https://discourse.gohugo.io/t/image-exif-and-usercomments-tag/49817][UserComment is extractable]] and Exif.Photo.UserComment is writable as are Exif.Image.PageName (and ReelName) but can't extracted (even with toml config set to [[https://gohugo.io/configuration/imaging/#exif-data][imaging.exif.includeFields = '.*']])

** DONE D2 diagramming
CLOSED: [2026-09-20 Sun 01:08]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260919_d2-diagramming
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/5a22ff63
:EXPORT_HUGO_IMAGES: /posts/20260919_d2-diagramming/image.jpg
:EXPORT_HUGO_MENU:
:END:
...
#+hugo: more
I watched this excellent video: [[https://www.youtube.com/watch?v=SsC-OsHR9RY][Beautiful diagrams in Emacs]] by [[https://skybert.net/][Torstein Krause Johansen]] and it got me interested in reexamining an easy way to integrate diagramming that is both declarative and tangled out, my Mermaid [[https://codeberg.org/shom/shom.dev/commit/aa85e3d19a2cc716881c974a6ea8ff3f5d8c4949][attempt]] wasn't that.
...
#+begin_src d2 :file ./images/posts/20260919_d2-diagramming/simple.svg
  foo -> bar: read
  bar -> foo: write
#+end_src

#+RESULTS:
[[file:./images/posts/20260919_d2-diagramming/simple.svg]]

#+begin_export hugo
{{< fig src="simple.svg" width="300 px" title="Simple D2 diagram" alt="Two boxes named foo and bar with arrows pointed to each other with lables read and write" align="center" >}}
#+end_export

Styling is fairly simple but I can't figure out to show to style all connectors but not shape borders.
#+begin_src d2 :file ./images/posts/20260919_d2-diagramming/styled.svg
  direction: right
  ,*.shape: circle
  foo -> bar: read
  bar -> foo: write{
...
#+RESULTS:
[[file:./images/posts/20260919_d2-diagramming/styled.svg]]

#+begin_export hugo
{{< fig src="styled.svg" width="600 px" title="Styled and animated D2 diagram" alt="Two cirlces named foo and bar with arrows pointed to each other with lables read and write in horizontal orientation where the 'write' arrow is dashed and animated" align="center" >}}
#+end_export

*** Webring diagramming
So if I were to [[../20240417_starting-a-webring-in-2024][recreate the webring diagram]] which started this "I wonder if" thought HOURS ago, it would look like:
#+begin_src d2 :file ./images/posts/20260919_d2-diagramming/webring.svg
  direction: right
  ,*.shape: circle
  A <--> B
  B <--> C
...
#+RESULTS:
[[file:./images/posts/20260919_d2-diagramming/webring.svg]]

#+begin_export hugo
{{< fig src="webring.svg" width= "800px" title="Webring diagram in D2" alt="Five circular nodes have a bidirectional connection to their immediate neighbors. Nodes are named A, B, C, D, E." align="center" >}}
#+end_export

And when I was trying to explain a broken webring, I could get quite fancy without /that/ much effort:
#+begin_src d2 :file ./images/posts/20260919_d2-diagramming/brokenwebring.svg
  direction: right
  classes: {
  broken: {
    style: {
...
#+RESULTS:
[[file:./images/posts/20260919_d2-diagramming/brokenwebring.svg]]
#+begin_export hugo
{{< fig src="brokenwebring.svg" width= "800px" title="Broken Webring" alt="Same ring as before but node C is broken and colored red and so are it's connections, all other connections are green and animated." align="center" >}}
#+end_export
...
** DONE Handworks 2026                                     :woodworking:life:
CLOSED: [2026-09-06 Sun 01:29]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260905_handworks-2026
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/78da46c9
:EXPORT_HUGO_MENU:
:END:
I'm an amateur woodworker and a very amateur (fine, almost not a) hand-tool user, but I attended Handworks and it was great.

#+hugo: more
#+begin_export hugo
{{< fig src="1handworksposter.jpg" width= "400px" title="Handworks Poster" alt="An art poster saying Handworks which looks like a 3D wood carving being done by a figure with a chisel and mallet on a workbench that says Amana, IA and the dates Sept 4-5 2026" align="center" >}}
#+end_export

[[https://www.handworks.co/][Handworks]] is woodworking event/gathering and was billed as
#+begin_quote
join modern woodworking hand tool makers and fellow enthusiasts for a weekend immersion in all things handwork. Unplug from the world of machines, dust and noise while listening to the crisp sounds of the hand plane, chisel and saw in a restored timber-frame dairy barn in the traditional, historic German village of Amana.
#+end_quote
I can attest that it was exactly that and I just realized that there was no sounds of loud woodworking power tools, which is nice. Here are a few photos and thoughts...

The quality of the tools that the craftspeople made was phenomenal. It was very clear that the indie makers were there for the love of the game. I loved that everyone was friendly and wanting to chat with anyone stopping by and not in a sales-y way. There was a lot of hands on demonstration and encouragement from the makers to pick up and interact with the tools. It is very clear that they are proud of what they made and want others to experience joy in using the tools.
#+begin_export hugo
{{< fig src="markingknives.jpeg" width= "600px" title="Marking knives with a display of steps" alt="Tool maker booth with marking knives, a work in process steps board, and a tiny lathe." align="center" >}}
#+end_export

It was cool to see that there were new tools as well as old tools that were restored. There were definitely old tools that were geared towards collectors but most of them were well loved and restored tools that were looking for a new home. Side note: I did see a Union no. 1 0XA hand plane that was on sale for $4500!!!
#+begin_export hugo
{{< fig src="usedtools.jpeg" width= "600px" title="Used tools looking for a new home" alt="Old woodworking tools for sale on table tops and people browsing" align="center" >}}
#+end_export

The event was across three locations that are within a short walk and it is a very cute town BUT it was very hot and humid (feels like temperature of 95F/35C).
#+begin_export hugo
{{< fig src="dairybarn.jpeg" width= "600px" title="Dairy barn and tents were at least breezy, sometimes" alt="Old barn with a yellow and white tent beyond." align="center" >}}
#+end_export
The main barn was absolutely packed, didn't spend too much time in there with the sea of sweaty bodies 🤢 (mine being chief among them).
#+begin_export hugo
{{< fig src="mainbarn.jpeg" width= "600px" title="Main barn was packed and had more of the big players" alt="An old barn with a light ropes on the pillars and just packed with people." align="center" >}}
#+end_export
That is also where the more commercial entities were so it was less interesting to me. BUT, the Veritas booth had their miniature series, which are fully functional and 100% adorable!
#+begin_export hugo
{{< fig src="miniaturetools.jpeg" width= "600px" title="Just look at those tiny adorable chisels" alt="A display of hand tools and there are tiny chisels and planes that look impractical but cute." align="center" >}}
#+end_export
While these are beautiful tools I think the indie maker tools are just works of art. Look at these tools made in Australia by HNT Gordon (pretty sure).
#+begin_export hugo
{{< fig src="australiahandtools.jpeg" width= "600px" title="Classic Plane Makers from Australia with native woods" alt="Classic wooden planes with brass and steel on a display table with a company banner in the background." align="center" >}}
#+end_export
Soooo... I got some really cool tools. I got a marking knife made from snakewood by [[https://personmakeobject.square.site/][Person Make Object]], a saddle square made from buckeye burl and brass by [[https://www.hillviewtool.com/][Hillview Metal&Wood]], and a ryoba saw. My friend also got a few things as well, here's our haul:
#+begin_export hugo
{{< fig src="toolhaul.jpeg" width= "600px" title="Our tool haul" alt="A bunch of tools on a white countertop made of wood and brass gleaming in the sunlight." align="center" >}}
#+end_export
I did not know that saddle square is a tool that existed but it is absolutely a tool I could have used a lot. Saddle squares let you mark a line on both adjacent (orthogonal) faces at the same time (or transfer your mark from one to the other). I struggle a lot transferring a measurement from one face to the next, especially if I need to take it to the opposite face, this will be a great help!

Amana Colonies have their own forestry service who sustainably manages the land and supplies their furniture making operation and lumber sales. They have a little show room attached to their workshop where skilled craftspeople make beautiful furniture. I wish I had taken some photos inside but look at the size of these Sycamore slabs
#+begin_export hugo
{{< fig src="sycamoreslab.jpg" width= "600px" title="Absolute unit Sycamore slab" alt="A very wide slab of spalted sycamore with a brown hand giving a thumbs up to show the scale. It is several feet across and perhaps five feet tall." align="center" >}}
#+end_export
I got a slab of walnut with the intent of making it a top of a coffee table. I'm very happy with the find, the figure is beautiful bacony figure 🥓 and will absolutely pop when finished.
#+begin_export hugo
{{< fig src="walnutslab.jpeg" width= "600px" title="A glamour shot of the walnut slab" alt="A walnut slab leaned up against a tree in a grassy yard. The slab has a lot of interesting grain/figure, beautiful swoops and swirls." align="center" >}}
#+end_export

The stack of boards also turned out excellent with only one board being less than desirable. A total surprise on the wide boards being sequential and can be used as a book-match! I bought these to mill up legs for the table but now I want to use the wide boards as a bookmatched table top, look at the 👀🦉
#+begin_export hugo
{{< fig src="walnutboards.jpeg" width= "600px" title="Walnut boards laid on table saw" alt="Six boards of walnut are laid on top of a table saw, there's of differing lengths and widths." align="center" >}}
#+end_export

I don't mean to cause envy but it's unavoidable for anyone aware of walnut prices... this 58"x18"x1¾" (145 x 45 x 4 cm) slab was $160 (USD). The bundle of boards all together roughly measuring 44" x 30" x 1" (110 x 75 x 2.5 cm) was $50 (USD).

It was a great trip with quality time with my good friend, excellent food, and cool people doing amazing work. Despite the oppressive heat, I would totally do it again and hope it was like 2023 weather wise when we walked around the explored the town.

A version of this post [[https://gts.shom.dev/@shom/statuses/01M1S3WWJ9TQE321D5XGRWFDMX][was shared as a thread]] on the Fediverse/Mastodon, feel free to comment there and share your experience.

** DONE In the market for assorted moldy fishes         :life:blaugust:scuba:
CLOSED: [2026-08-31 Mon 21:26]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260831_in-the-market-for-assorted-moldy-fishes
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/db490df9
:EXPORT_HUGO_IMAGES: /posts/20260831_in-the-market-for-assorted-moldy-fishes/scorpionfish.jpg
:EXPORT_HUGO_MENU:
:END:
A bit of a follow-on from the [[../20260830_any-day-diving-is-better-than-a-day-without-diving][previous post]], today was only a good day because it included diving and one moldy fish that keeps hope alive.

#+hugo: more
We went down to Lauderdale by the Sea today and the dive was kind of a bust. The reef is interesting but the visibility was 3 to 10 feet-ish at best. This has been a bit of an unlucky trip from fauna, conditions, and equipment. Side note: got my octo-inflator serviced and back from the dive shop, the rental worked out nicely; the BCD (a Zeagle with a backplate) is a very tempting upgrade.

The visibility made photography almost pointless but I halfheartedly took some photos and near the very end of the dive, I spotted a Scorpion fish. Very well camouflaged until it decided I was sus and moved... into the open and opened up the beautiful underside of its fin. Well not very good camouflage but I will take it as a sign to not get discouraged because seeing their fin is quite rare indeed.
#+begin_export hugo
{{< fig src="scorpionfish.jpg" width= "800px" title="A scorpion fish - moldy camouflage expert" alt="A scorpion fish is sitting on a reef and would be totally blending in except it is showing the underside of its fins which is very colorful bands of yellow, black, and pink." align="center" >}}
#+end_export

One more dive tomorrow, depending upon your worldview you're either going to give up hope and be pleasantly surprised if something good happens or be full of hope and manifest any of the moldy looking fishes we're in the market for: moldy frogfish, moldy batfish, moldy seahorse, moldy stonefish, really any moldy looking weird fish will do. Thanks moldy scorpionfish, is this a sign to keep hope alive?

~note to fellow pedants:~ plural of fish is fish when it's the same kind of fish, when it's a variety of them, it's fishes. Happy to be corrected if this isn't right.

** DONE Any day diving is better than a day without diving :life:blaugust:scuba:
CLOSED: [2026-08-30 Sun 22:17]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260830_any-day-diving-is-better-than-a-day-without-diving
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/ae697421
:EXPORT_HUGO_IMAGES: /posts/20260830_any-day-diving-is-better-than-a-day-without-diving/image.jpg
:EXPORT_HUGO_MENU:
:END:
Today it rained, I had equipment issues, and we saw "nothing good" but any day diving is better than day without diving.

#+hugo: more
I'm on a short dive trip with a friend, diving the Blue Heron Bridge off Phil Foster Park by West Palm Beach, Florida. It is the least glamorous dive spot, literally under a bridge; not a cool suspension bridge, a flyover. But somehow through some magic some of the coolest critters show up here. I've seen some [[https://photos.shom.dev/scuba/blueheron/][truly amazing things]] here, today was not one of those days.

The day started out with great weather, bright sunny skies. But it started raining the moment we set foot in the water. Rain under water looks really neat but nothing else looks neat when you have no light.
#+begin_export hugo
{{< fig src="rain.jpg" width= "800px" title="wet on wet" alt="An abstract scene of light blue on the top of the frame making way to darker blues towards the bottom with a lot of undulating dappled texture throughout the image. It's a photo of rain falling on the surface of water taken from underwater." align="center" >}}
#+end_export

But with the rain it wasn't that pretty, the visibility was poor, we found nothing in the grass or anything we hadn't seen a bunch before. I also experienced equipment issues because my secondary air supply which is also my Buoyancy Control Device (BCD) inflator started free-flowing after just having been serviced this week.

Here's where I admit that I've become a bit of a snob; unless I see something that is truly rare (to me) then it feels like I saw nothing. So basically, if it's not a seahorse, octopus, batfish, or something equally wild it doesn't feel successful. I totally understand people catching Pokemon. Do birders get this way too?

#+begin_export hugo
{{< fig src="eel.jpg" width= "800px" title="'Hey guuuuuuys, let's hang out underwater sometime, preferably in a tube!'" alt="An extreme close up for a sharp tail eel which has this goofy nostrils and a single eye visible, cute and derpy expression" align="center" >}}
#+end_export

Sometimes it takes a bit longer than I like for me to realize that I get to choose: I got to dive today and that makes today a great day. I saw a lot of wonderful fish, crabs, eels, even a stone fish and the dive shop was so great they will service my gear again and gave me a free rental so I could dive again tomorrow. Diving is awesome and any day I get to hangout underwater with my eel friend here is a great day that I'm grateful for.

** DONE Like tears in the rain                                :life:blaugust:
CLOSED: [2026-08-29 Sat 22:57]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260829_like-tears-in-the-rain
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/b5612cf2
:EXPORT_HUGO_IMAGES: /posts/20260829_like-tears-in-the-rain/atlantic_storm.jpg
:EXPORT_HUGO_MENU:
:END:
As I sat on the dark beach listening to the sounds of the crashing waves and the very faint roar of thunder from the distant flashes of lightning, I wondered if will I think of this serene moment again? How many times will I remember this memory? Or will
#+begin_quote
All those moments will be lost in time, like tears in rain.[fn:BladeRunnerTearsInRain]
#+end_quote

#+hugo: more
#+begin_export hugo
{{< fig src="atlantic_storm.jpg" width= "600px" title="Dark 'n Stormy" alt="A dark image of the ocean at night but the white foam from the crashing wasves on the beach is visible against the greenish blue of the water and the dark blue of the sky with some gray storm clouds and a hint of lightning in the distance." align="center" >}}
#+end_export

"Like tears in rain" is an iconic line that is etched in many people's memories. It pops up in my mind a lot and elucidates a strong emotional reaction. There are a few others from movies/shows that do the same (all are spoilers so I won't reference any of the specifics) and my thoughts aren't specific to any single quote but I find it fascinating that these stick with me.
#+begin_quote
Not like this. [fn:MatrixNotLikeThis]
#+end_quote
I think what all of these have in common is that they are paradigm shifting but more importantly they are said by people with a lot of heart, believers. 
#+begin_quote
Not Penny's Boat. [fn:LostNotPennysBoat]
#+end_quote
They also touch on impermanence but how that impermanence gives way to a broader reality, where there are more questions than answers.
#+begin_quote
What door? [fn:WestworldWhatDoor]
#+end_quote
Where how we define ourselves and /this world/ shifts but it's not a lack of hope, it's profound possibilities.

My personal north star is that we're all motes of dust in an ocean of time, and the least I hope to do is make the lives of the other motes that I bump into slightly better instead of slightly worse. This impermanence is personified when I watch the ocean and its crashing waves: utter chaos dressed in beautiful rhythm; destroying and creating in the same motion; unpredictable but inevitable. There is no profundity, just waves shaping lives and we get to choose the motes of dust and the moments of time to remember. 

So I hope that do I remember this moment; the cool breeze after a hot muggy day, the sound of waves punctuated by thunder, and the piece of Key Lime pie that made me walk over to the beach to begin with.

*** Footnotes

[fn:LostNotPennysBoat] LOST
[fn:MatrixNotLikeThis] The Matrix
[fn:WestworldWhatDoor] Westworld
[fn:BladeRunnerTearsInRain] Blade Runner

** DONE Fedi thread to blog post           :littleFedi:fediverse:ui:blaugust:
CLOSED: [2026-08-09 Sun 20:29]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260809_fedi-thread-to-blog-post
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/7f1e5964
:EXPORT_HUGO_IMAGES: /posts/20260809_fedi-thread-to-blog-post/proposal.png
:EXPORT_HUGO_MENU:
:END:
Aside from being a [[../20260801_i-m-a-cyclical-hobbyist-dot-dot-dot/][cyclical hobbyist]] I don't blog as much as I potentially could because I end up posting something on Fedi and repeating myself feels weird unless it's something [[../20260730_the-hummingbird-and-the-hound/][completely bonkers]] that I want to capture for posterity. Last week I thought about writing an application that did just that and link it to this here blog. But the last few days I've been preoccupied with [[https://littleone.littlefedi.social/][littleFedi]].
...
#+begin_export hugo
{{< fig src="proposal.png" width= "600px" title="littleFedi threaded post to blog mockup" alt="Screenshot of a html composite of the littleFedi edit inteface and threaded replies with check boxes in front of each thread, not all boxes are checked for demonstration." align="center" >}}
#+end_export
link to post shown: https://littleone.littlefedi.social/@shom/1ad99f9c-2c9a-47d2-80fa-04399dc477d5

** DONE Big hopes for littleFedi  :fediverse:selfhosting:blaugust:littleFedi:
CLOSED: [2026-08-08 Sat 22:35]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260808_big-hopes-for-littlefedi
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/c5e65606
:EXPORT_HUGO_IMAGES: /posts/20260808_big-hopes-for-littlefedi/image.jpg
:EXPORT_HUGO_MENU:
:END:
The Fediverse is exciting, I've formed genuine connections with interesting people. [[https://gotosocial.org/][GoToSocial]] got me hosting my own presence. And I hope [[https://littleone.littlefedi.social/][littleFedi]] is what gets to hosting a community.
#+hugo: more
...
Well maybe it's a better idea to talk about what is littleFedi is?! I'll let [[https://littleone.littlefedi.social/@stefano][Stefano]] talk about that: [[https://littleone.littlefedi.social/@stefano/blog/2026/08/07/littlefedi-a-fediverse-server-that-doesn-t-need-a-data/][littleFedi: a Fediverse Server That Doesn't Need a Data Centre]]. That blog is actually served directly by littlFedi and the post was created as any other regular post AND the blog is statically served AND a regular post can be retroactively turned into a blog post AND it supported threaded comments (since it also remains a regular ActivityPub post). littleFedi has a load of other great features as well and I don't want to take away from that but this is definitely what sets it apart from GoToSocial.
#+begin_export hugo
{{< fig src="littleFedi.png" width= "600px" title="littleFedi post page" alt="Screenshot of littleFedi default teal and black theme showing a social post with nested comments and likes and boosts metadata" align="center" >}}
#+end_export
...
#+begin_export hugo
{{< fig src="blog.png" width= "600px" title="Same post as a static blog" alt="The same content has been rendered into a distinct blog interface and the comments from the fedi post are displayed as nested blog comments." align="center" >}}
#+end_export

*** What's next?
[[https://littleone.littlefedi.social/@shom][I'm on the test instance]] and have been doing some testing and providing feedback. Stefano is both very prompt and gracious in receiving feedback and fixing issues. The project will be released as a MIT licensed self-hostable application and I plan on trialing a niche community hub (more on that later) using littleFedi. I wish the project well and will be following it closely and eagerly.

** DONE Morning joy                                           :life:blaugust:
CLOSED: [2026-08-04 Tue 00:19]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260803_morning-joy
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/34527634
:EXPORT_HUGO_IMAGES: /posts/20260803_morning-joy/image.jpg
:EXPORT_HUGO_MENU:
:END:
...
#+hugo: more
#+begin_export hugo
{{< fig src="latte.jpg" width= "600px" title="A latte to like about the morning" alt="A white coffee cup on a dark walnut wooden table top with some latte 'art' somewhere between and onion and a heart" align="center" >}}
#+end_export
...
I like the diffused light of the morning when dew is burning off.
I like the bird songs.
I like knocking out a clean puck of espresso after I've pulled a shot.
And of late I like how sweet and loving this pup is in the morning. We get up and do some stretching on the floor, which is her cue to find a way to be under me regardless od how much ground clearance there might be and give my face a bath any opportunity she finds. I also an enjoying the morning walk with the long shadows and the aforementioned light and birds.

#+begin_export hugo
{{< fig src="shadows.jpeg" width= "600px" title="Long shadows" alt="Elongated shadows of a person and a dog (in profile) stretched out over grass lit by a soft morning sun." align="center" >}}
#+end_export

I can love these things, but I have no intention of becoming a /virtuous/ morning person. To them I have the same question as Hozier:
#+begin_quote
...
** DONE I'm a cyclical hobbyist...                            :life:blaugust:
CLOSED: [2026-08-01 Sat 19:54]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260801_i-m-a-cyclical-hobbyist-dot-dot-dot
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/07bc55b5
:EXPORT_HUGO_IMAGES: /posts/20260801_i-m-a-cyclical-hobbyist-dot-dot-dot/golden-sunset.jpg
:EXPORT_HUGO_MENU:
:END:
...
#+hugo: more
#+begin_export hugo
{{< fig src="golden-sunset.jpg" width= "600px" title="Film photography magic, not knowing if you got it until later and it's awesome when you did get it." alt="A sunset scene at Baker Beach by the Golden Gate Bridge in San Fransisco, CA, USA. The sun is setting off screen to the left and casting a beautiful light sideways towards the subjects which is further scattered by the spray in the air. A wave is crashing in from the left with white foamy water rushing onto the sand and covering most of the bottom third, beyond which are the rocks that have caused a huge splash of brilliant white spray just in front of a couple that is standing front to back on some rocks hugging framed in between to two towers of the Golden Gate Bridge in the background which stands under a blue sky with scattered fluffy clouds. Shot with a Voigtlander BessaR3M and Voigtlander40f1.4MC lens, on KodakKodacolor100, and developed with LabDev by Shom Bandopadhaya. Licensed under Creative Commons Attribution-NonCommercial-ShareAlike (CC BY-NC-SA)." align="center" >}}
#+end_export

Last week I pulled up my for-fun [[../20251228_let-s-go][acoustic-coding Go project]] the last commit was from April 27th, exactly 3 months ago. Well that just smells like yet another abandoned project. But instead of feeling bad, I tied up the main functionality and added a small feature (after getting reacquainted with the code). It started as an elaborate joke and my mate and I had a chuckle, delightful.

In the last year or so I've realized that I'm a *cyclical hobbyist* and instead of feeling guilty for not doing my hobbies consistently (I know it sounds ridiculous) I have accepted that! This means that my projects don't have to be abandoned projects, they can just be on hold and I can pick them up when I'm interested again. This is fundamentally different than being a serial hobbyist, where you're chasing novelty; not saying I won't add hobbies but I genuinely like the thing and come back to them. Part of me is sulking that I'm learning basic things like this about myself this late in life, but the rest of me is trying to learn how to be happy about small victories that change the larger narrative about my self lore. Be kinder to yourself y'all, it works 😭

So what are these hobbies that I cycle between?! I enjoy [[https://photos.shom.dev/film/][film photography]], [[https://phanpy.social/#/mastodon.social/s/116479730120274093][woodworking]], [[https://phanpy.social/#/mastodon.social/s/115470036738640175][bicycling]], [[https://photos.shom.dev/scuba/][scuba diving]], [[https://phanpy.social/#/mastodon.social/s/114123564188306239?media=1][open hardware/software]], [[https://phanpy.social/#/mastodon.social/s/114966498152501004?media=1][watercoloring]], and [[https://craftering.systemcrafters.net/][indie web/blogging]].

** DONE The Hummingbird and The Hound                              :fun:life:
CLOSED: [2026-07-30 Thu 22:35]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20260730_the-hummingbird-and-the-hound
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/4f866734
:EXPORT_HUGO_IMAGES: /posts/20260730_the-hummingbird-and-the-hound/1sandy-and-ernest.jpeg
:EXPORT_HUGO_MENU:
:END:
The story of The Hummingbird and The Hound, originally told in a [[https://gts.shom.dev/@shom/statuses/01KY8GXK3CJ1RXZXGKAVK2MMP1][series of posts on the fediverse]].
#+hugo: more

It's was a day! I'm dog sitting for a friend's very high energy young rescue with more than a touch of separation anxiety. We go on a lunch walk and stumble upon this hummingbird. How do you try to help a tiny struggling bird while a high prey drive dog wants to pounce on it!?
#+begin_export html
<video controls width="800" align="center">
<source src="./hummingbird-street.mp4" type="video/webm" />
<track kind="subtitles" src="alt_hummingbird-street_en.vtt" srclang="en" />
</video>
#+end_export
#+begin_src org :exports none :tangle content/posts/20260730_the-hummingbird-and-the-hound/alt_hummingbird-street_en.vtt
  WEBVTT
  ...
  Video of a sidestreet where a tiny green hummingbird is fluttering desperately but unable to fly or even make it onto the grass.
  #+end_src
=Note:Alt-text provided as closed-caption=

This is the dog, Sandy. She is very very sweet but loses her mind when she sees a prey animal (we're working on it).
#+begin_export hugo
{{< fig src="sandy-window-ledge.jpeg" width= "600px" title="Sandy patrolling from the window ledge" alt="A brown yellow dog who looks like a dingo in profile with giant antenna ears looks out the window standing on a window bench." align="center" >}}
#+end_export
#+begin_export hugo
{{< fig src="sandy-sniff.jpeg" width= "600px" title="Sandy sniffing" alt="Same dog calmly smelling grass and tiny yellow flowers." align="center" >}}
#+end_export

Well I don't know how but I managed to grab the bird without Sandy eating him (don't know gender using him to distinguish from she dog). Well she wouldn't eat him per se but violently shake him and launch him into orbit. I still needed to do a little bit more of the walk to keep Sally from being too energetic. This bird (does he need a name?) was so exhausted that it just lay in my hand and didn't even have the energy to squeak or struggle.
I got him back home and tried to get him to drink some sugar water. Y'all this bird is so tiny and had a thinner than needle tongue. He was drinking the sugar water and surprisingly Sandy didn't notice.
#+begin_export hugo
{{< fig src="hummingbird-espresso-cup.jpeg" width= "600px" title="Shots of espresso, err sugar water" alt="A tiny green hummingbird is sitting in the open palm of a light brown hand looking into an espresso cup with a spoon sticking out of it." align="center" >}}
#+end_export
#+begin_export hugo
{{< fig src="1sandy-and-ernest.jpeg" width= "600px" title="Ernest and Sandy" alt="Same bird and same hand show the dog from before laying on the floor facing away being completely oblivious." align="center" >}}
#+end_export
~note~: someone suggested the excellent name [[https://oslo.town/@matt/116971693497428603][Ernest Hummingway]].

I cannot emphasize enough how tiny and how still this bird was. I've never seen a hummingbird be still but it was encouraging to see him move his neck around a bit and blink. The sugar water treatment carried on for a while.
#+begin_export html
<video controls width="800" align="center">
<source src="the-hummingbird-and-the-hound.mp4" type="video/webm">
<track kind="subtitles" src="alt_the-hummingbird-and-the-hound_en.vtt" srclang="en">
</video>
#+end_export
#+begin_src org :exports none :tangle content/posts/20260730_the-hummingbird-and-the-hound/alt_the-hummingbird-and-the-hound_en.vtt
    WEBVTT
    ...
    2
    00:00:03.000 --> 00:00:10.000
  A video of a tiny green hummingbird on an open palm of a light brown hand being panned around the kitchen and a laying dog can be seen out of focus in the background at the end of the video.
  #+end_src
=Note:Alt-text provided as closed-caption=

I took him outside with the dog along on a leash (see separation anxiety from above) and felt like a Disney Princess but the struggling single mom flavor desperately trying to make sure one kid doesn't eat the other. Everytime he would try to fly away he would just struggle to the ground immediately. It was not safe for him to be inside or outside.
#+begin_export hugo
{{< fig src="hummingbird-close-up.jpeg" width= "600px" title="Ernest close-up in the sun" alt="A beautiful iridescent green hummingbird in the open palm of a light brown hand under bright sunshine, green grass in the background." align="center" >}}
#+end_export
#+begin_export hugo
{{< fig src="hummingbird-sunshine.jpeg" width= "600px" title="Sooo pretty" alt="Same as before but more zoomed out. Copied description below. A beautiful iridescent green hummingbird in the open palm of a light brown hand under bright sunshine, green grass in the background." align="center" >}}
#+end_export

Well at this point I had no choice but to attend a meeting with a hummingbird in the hand. He was definitely worth more than two hummingbirds in the bush.
#+begin_export hugo
{{< fig src="hummingbird-meeting.jpeg" width= "600px" title="Ernest and I attended some meetings (should have signed an NDA)" alt="Tiny green hummingbird sitting on the open palm of a lightbrown hand against the chest of a person wearing a gray shirt." align="center" >}}
#+end_export
Over the next two hours his strength started returning and I tried to move his wing a bit so it was not stuck under his other feathers. He peed on me. But eventually started getting feisty but still not able to fly. Keeping Sandy oblivious was very stressful!
#+begin_export hugo
{{< fig src="sandy-sleeping.jpeg" width= "600px" title="For a long while thankfully Sandy was oblivious and took some naps" alt="A yellow brown dog is curled into a tight ball and sleeping on top of a plaid fleece blanket." align="center" >}}
#+end_export

He started getting more feisty so I put him outside on the grass and left him with some sugar water. Checked on him a couple times throughout the afternoon. Called the Humane Society, they can't help but said I could bring him in a box to the county to euthanize him 😭

In the meanwhile he had perched himself on some grass (on grass! this is a tiny bird). I left my phone inside in the chaos of making sure Sandy didn't eat him so no photos, she clued in big time when he got more and more feisty.  and when I finally came back at the end of the work day, he was gone.

I'd like to think to greater adventures or he became part of the food chain. But we tried the best we could. And that's the story of how I spent an afternoon with a hummingbird in the palm of my hand, wild!

** DONE Let's Go                                        :hugo:gotosocial:foss:
CLOSED: [2025-12-28 Sun 02:48]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20251228_let-s-go
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/53dfbebc
:EXPORT_HUGO_IMAGES: /posts/20251228_let-s-go/202311_Peoria_120IlfordFP4_0003.jpg
:EXPORT_HUGO_MENU:
:END:
So without making a conscious choice I've been using and loving some excellent Go-lang software: [[https://gohugo.io/][Hugo]], [[https://gotosocial.org/][GoToSocial]], and [[https://readeck.org/en/][Readeck]]. I don't know Go but I've picked up some templating from customizing Hugo (which powers this blog), is it time I learned more? Let's [[https://go.dev/][Go]]!!!
#+hugo: more
I don't engineer/code for work anymore so I don't have proficiency in any specific language and for some reason that has been bothersome. I do write some ad-hoc and nominal (terrible) Python and SQL, neither of which I have written professionally before, so I've been thinking about increasing my Python proficiency. But... that's not where my tinkering/crafting heart has been, although [[https://fastht.ml/][FastHTML for Python]] is a really interesting proposition.

I've also rooted around in [[https://rust-lang.org/][Rust-Lang]] and really love the core concepts of borrow-checker and memory-safety; wish I had that when I was (poorly) working in embedded software (so. many. segfaults.). I've read some of the Rust book and even contribute a bit to a Rust project ([[https://github.com/k3rs3d/ringfairy][Ringfairy]]) but realistically I do not have the focus and drive to gain any proficiency in Rust.

#+begin_export hugo
{{< fig src="202311_Peoria_120IlfordFP4_0003.jpg" width= "400px" title="I don't have a gopher (Go mascot) photo but I do feel like a coffe'ed up bear" alt="Black and white photo of a taxidermied polar bear dyed black holding a coffee cup in front of a brick wall and very bright windows to either side." align="center" >}}
#+end_export
...
If you have tips or want to chat, [[https://gts.shom.dev/@shom/statuses/01KDJ2Y9G6MGXAFQRYBDB3ES04][catch me on the fedi]].
...
** DONE Anatomy of a yak-shave               :selfhosting:forgejo:containers:
CLOSED: [2025-11-30 Sun 00:02]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20251129_anatomy-of-a-yak-shave
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/f80d6631
:EXPORT_HUGO_IMAGES: /posts/20251129_anatomy-of-a-yak-shave/image.jpg
:EXPORT_HUGO_MENU:
:END:
In an EPIC bout of [[https://en.wiktionary.org/wiki/yak_shaving][yak-shaving]] I have reduced the build time for this static site infrastructure running on a puny VPS by a factor of 5. Come along on this undiagnosed journey.

#+hugo: more
#+begin_export hugo
{{< fig src="buildtimes.png" width= "600px" title="Build times reduced by 5x" alt="Screenshot of side by side build steps and their elapsed times. Both builds have passed, the one on the left took 13 minutes and 22 seconds, while the right took 2 minutes and 45 seconds." align="center" >}}
#+end_export
...
Anatomy of a yak-shave:
  ...
  - All the freaking examples are for using public forges with public container registries ([[https://codeberg.org/shom/shom.dev/src/commit/a8eb4a6d979b952711178cfd15765afbac9660b9/.forgejo/workflows/build.yml][use credentials with a Personal Access Token]])
...
If you want to commiserate, [[https://gts.shom.dev/@shom/statuses/01KB9NAC9ERVE2G8D8A4A2F9FN][drop me a line]].
** DONE Phanpy custom build for self-hosting :selfhosting:containers:gotosocial:
CLOSED: [2025-11-27 Thu 16:01]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20251127_phanpy-custom-build-for-self-hosting
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/b61138e3
:EXPORT_HUGO_IMAGES: /posts/20251127_phanpy-custom-build-for-self-hosting/phanpy-compose.png
:EXPORT_HUGO_MENU:
:END:
[Phanpy](https://phanpy.social/) is an excellent front-end client for Mastodon compatible Fediverse instances that I use with [GoToSocial](https://gotosocial.org/). Here's how I build the Progressive Web App (PWA).

#+hugo: more
#+begin_export hugo
{{< fig src="phanpy-compose.png" width= "600px" title="Phanpy compose window now automatically reads the alt-text embedded in image files" alt="A screenshot of Phanpy compose window with two black and white images added and the alt-text filled out." align="center" >}}
#+end_export
...
I'm sure there are better and more idiomatic ways of doing this, so if you have any suggestions [[https://gts.shom.dev/@shom/statuses/01KB3S1F1P2JQ80NWMX4S1JTE1][please drop me a line]].

** DONE EXIF for Film Photos                       :hugo:darktable:exif:film:
CLOSED: [2025-09-28 Sun 23:44]
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: 20250928_exif-for-film-photos
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :aliases /s/ed4cc349
:EXPORT_HUGO_IMAGES: /posts/20250928_exif-for-film-photos/darktable-export-exif-mapping.png
:EXPORT_HUGO_MENU:
:END:
...
#+hugo: more
The primary thing I want is embedded alt-ext in EXIF Image Description. But I also wanted to display an image title, which was fraught. I had a "workable" solution going with Hugo by cheating the EXIF artist flag for the title of the image (since the only other field UserComment was pre-pending everything with ~ASCII~) but that seems to have resolved itself thankfully because I could not stand that metadata "corruption". AND I got some great advice from [[https://toot.community/@tmcfarlane][tmcfarlane]] [[https://toot.community/@tmcfarlane/115242078564848872][in this fedi thread]] about exporting tags in [[https://www.darktable.org/][Darktable]].

#+begin_export hugo
{{< fig src="darktable-export-exif-mapping.png" width= "600px" title="Darktable Export Preference Dialog" alt="Darktable Export Preferences dialog box showing the EXIF data checkbox off and all the pertinent tags redefined under Exif.Image.$ and Exif.Image.ImageDescription is set as $(Xmp.dc.description) Shot with a $(CATEGORY0(Camera)) $(CATEGORY1(Camera)) and $(CATEGORY0(Lens)) lens, on $(CATEGORY0(Film)), and developed with $(CATEGORY0(Developer)) by $(Xmp.dc.publisher). Licensed under $(Xmp.dc.rights)." align="center" >}}
#+end_export
I had already been using hierarchical tags for Camera, Film, and Developer but now knowing that I could actually overwrite the EXIF on the exported image, opened up more ideas and investing more heavily in tags made sense. I broke up the Camera hierarchy to =Camera|Make|Model= added a =Lens|Model= (might expand to =Lens|Model|FocalLenght|Aperture=) in the future and added =ISO= in addition to Film (maybe future possibility is =Film|Manufacturer|Brand|ISO=). Currently, I'm appending the meta data at the end of the =EXIF.ImageDescription= and displaying that on alongside the image. But now I will have the opportunity to customize more and actually show the true EXIF and not what the "scanning camera" records.
#+begin_export hugo
{{< fig src="red-shed.jpg" width= "600px" title="Red Shed photo with alt and metadata" alt="Screenshot of the image that is linked below which shows the title of 'Red Shed' and alt-text as it appears on the image." align="center" >}}
#+end_export
This is what the final presentation [[https://photos.shom.dev/film/mamiya-six/#20250902_202506_mxxxx_peoria_harmonphoenixi_mamiyasix_0017.jpg][looks like on my photos site]]. The good part about this approach of putting all the metadata in the image description is that not all images need to re-tagged and re-exported all at once and the site won't break. When all the image are properly tagged, I'll create a metadata section similar to what you see below, but note that the EXIF information showing the camera setup used for scanning the negative (the whole reason I'm doing all this song and dance) so all images *have* to be tagged and exported. Also, I don't keep good enough notes while shooting, so I'll likely remove the aperture and shutter speed, despite their very cool SVG icons.
#+begin_export hugo
{{< exif src="commercial-street.jpg" caption="Hugo template for displaying EXIF data" alt="Color of a red door with two panes each with a glass window. Above the door is is another horizontal pane of glass with the words 'COMMERCIAL STREET' emblazoned in gold. The door has trim decoration a heavily patina'd copper door handle and some shiny bronze splash guards at the bottom. The opposite side of the street is reflecting a nondescript scene of an alley, the reflection of the photographer is missing. The vibe is of by gone glory fallen into disrepair." >}}
#+end_export
If you're interested in how this template came to be , I wrote about it a while ago: [[../20220128_hugo-photos-with-exif-data/][Hugo photos with EXIF data]].

** DONE Forgejo'ing forward        :foss:hugo:containers:selfhosting:forgejo:
...
[[https://forgejo.org/][Forgejo]], finally, the titular character! I've run Forgejo, and Gitea before that, for many years and it has been awesome to see all the great functionality that has been added over time (Actions for instance). I am also very much looking forward Forgejo's federation, the real promise of distributed development and collaboration. I've wanted to move the CI/CD infrastructure to Forgejo but had to work through several things:
...
This is all running on my Forgejo instance but I'm not exposing that to the web. Just seeing how hard my static site gets hit with bots, expensive end-points like git will knock me over in no time (eventually maybe with [[https://github.com/TecharoHQ/anubis][Anubis]] in the middle). So Codeberg will remain my public remain facing repo and the main branch will reflect what is deployed on the site.
...
** DONE Hugo photos with EXIF data                           :foss:hugo:exif:
...
:END:
=2026 Update:=
This continues to be one of the most visited posts on my site, mostly by bots but here's an update for humans. I have been using Darktable full time for over 5 years now, I do not miss Lightroom. I think these [[https://www.youtube.com/watch?v=SiWBZ3FOMo8&list=PLtEQQgn1V_PcrulNvoon21Pf8AuUVf5HL][Darktable tutorials]] are the best way to get started and using Filmic and RGB primaries are really the only two modules you need. Happy to chat about it more, come find me on the [[https://gts.shom.dev][Fediverse/Mastodon]].
