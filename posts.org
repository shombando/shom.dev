...
However, 
#+hugo: more
we allow this when we cede control to third parties (not just cloud) without mitigation plans, by NOT:
...
=Originally posted on [[https://fosstodon.org/@shom/112513200445089689][Mastodon]].=
