...
** DONE The Hummingbird and The Hound                                   :fun:
...
:EXPORT_HUGO_IMAGES: /posts/20260730_the-hummingbird-and-the-hound/image.jpg
:EXPORT_HUGO_MENU:
:END:
...
#+end_export
#+begin_export hugo
{{< fig src="./sandy-and-ernest.jpeg" width= "400px" title="Ernest and Sandy" alt="Same bird and same hand show the dog from before laying on the floor facing away being completely oblivious." align="center" >}}
#+end_export
...
#+begin_export hugo
{{< fig src="./the-hummingbird-and-the-hound.mp4" width= "400px" title="The Hummingbird and The Hound both passed out" alt="A video of a tiny green hummingbird on an open palm of a light brown hand being panned around the kitchen and a laying dog can be seen out of focus in the background at the end of the video." align="center" >}}
#+end_export
