...
:EXPORT_HUGO_MENU:
:END:
There's a new section on the website for Film Photography that is being by Hugo but independent of the blogging workflow. I'll create a new entry documenting how that is setup in a follow-up post.
...
:EXPORT_FILE_NAME: _index
:END:
I had shot two rolls of film in college but couldn't afford the on-going expense, but I really wish I had found my way back to film photography sooner. Better late than never. I'm shooting fully manual cameras, most of them without any built-in light meters. I'm now developing and scanning black & white negatives at home and plan to take on color film soon.

Here's a running log of photos that I'm taking. I have a goal to share at least one photo per roll and eventually also print a photo per roll. Each photo is tagged with the camera, film, and development process, and the alt-text for each image is included as a figure caption as well. The focus is the image so the title and descriptions are in muted colors. Finally, clicking on the image from it's own page will load a higher resolution version. Please get in touch if you want to chat about film photography, the best place to find me is on [[https://fosstodon.org/@shom][Mastodon]].
