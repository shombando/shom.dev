...
So, I created and have been using a custom configuration for Emacs. This is something I didn't really see myself doing when I started using Emacs.

*** Doom 
I started my Emacs journey with [[https://github.com/hlissner/doom-emacs/][Doom]] and have been learning things along the way. This was a great way to get started. Borrowing configuration snippets and blindly copying and pasting got me up and running quickly which was great. I did find the vastness of Doom intimidating and knew that I wasn't using all the functionality and wasn't really discovering it given the jam packed key-maps.  
