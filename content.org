...
=Editorial note=: The API isn't French, it's Le for Let's Encrypt... capitalizing acronyms in variable names is always contentious, snake case should makes it easier. But mixing usage seems like the worst of all choices.
...
I'm not suggesting anyone do this, but it's a fun example UNIX principles and pipes.
